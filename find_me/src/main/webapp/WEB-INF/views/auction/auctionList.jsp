         ...
         <div class="container">
            ...
            <ul class="stuff-list ul--auction row align-items-stretch">
               <c:forEach items="${aList }" var="auction">                  
                  <fmt:parseDate value="${auction.auctionBeginDate }" var="strPlanDate" pattern="yyyy-MM-dd" />
                  <fmt:parseNumber value="${strPlanDate.time / (1000*60*60*24)}" integerOnly="true" var="strDate">
                  </fmt:parseNumber>
                  <fmt:parseDate value="${auction.auctionEndDate }" var="endPlanDate" pattern="yyyy-MM-dd" />
                  <fmt:parseNumber value="${endPlanDate.time / (1000*60*60*24)}" integerOnly="true" var="endDate">
                  </fmt:parseNumber>
                  <li class="col-3">
                     <span class="auction__time-limit">${endDate- strDate }</span>

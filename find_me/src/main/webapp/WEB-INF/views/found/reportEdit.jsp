...
<body>
    ...
    <section id="sub" class="found-report">
        ...
        <section class="sub__conts">
            <div class="container">
                <h3>습득물 신고 수정</h3>
                <form class="report__form" action="/found/update.do" method="post" enctype="multipart/form-data">
                <input type="hidden" id="userId" name="userId" value="${userId}">
                <input type="hidden" id="foundPostNo" name="foundPostNo" value="${foundPostNo}">
    ...
    <script> 
		...
		var postNo = $("#foundPostNo").val();
		console.log("foundPostNo ::: " +postNo);
    </script>
</body>
